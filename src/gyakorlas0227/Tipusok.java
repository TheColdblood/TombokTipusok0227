...
public class Tipusok {
    public static void main(String[] args) {
        ...
        System.out.println("Karakter intervallum");
        System.out.printf("min %-5s (betű): %20c\n", "char", Character.MIN_VALUE);
        System.out.printf("max %-5s (betű): %20c\n", "char", Character.MAX_VALUE);
        System.out.printf("min %-5s (szám): %20d\n", "char", (int)Character.MIN_VALUE);
        System.out.printf("max %-5s (szám): %20d\n", "char", (int)Character.MAX_VALUE);
